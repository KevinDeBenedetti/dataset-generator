  ...
  return (
    <div className="quality-page">
      ...
      <div className="stat-grid" style={{ marginBottom: 18 }}>
        ...
        <div className="card stat">
          <div className="stat-top">
            <span className="stat-label">Below 0.80 threshold</span>
            <span className="stat-ic">
              <Icon name="alert" />
            </span>
          </div>
        ...
        <div className="card">
          ...
          <div className="card-body" style={{ paddingTop: 6 }}>
            <div className="bar-row">
              <span className="bl">0.9–1.0</span>
              <div className="progress" style={{ flex: 1 }}>
                <span style={{ width: '72%' }} />
              </div>
              <span className="bv">924</span>
            </div>
            <div className="bar-row">
              <span className="bl">0.8–0.9</span>
              <div className="progress" style={{ flex: 1 }}>
                <span style={{ width: '24%' }} />
              </div>
              <span className="bv">317</span>
            </div>
            <div className="bar-row">
              <span className="bl">0.7–0.8</span>
              <div className="progress" style={{ flex: 1 }}>
                <span style={{ width: '5%', background: 'var(--warning)' }} />
              </div>
              <span className="bv">28</span>
            </div>
            <div className="bar-row">
              <span className="bl">&lt; 0.7</span>
              <div className="progress" style={{ flex: 1 }}>
                <span style={{ width: '2%', background: 'var(--destructive)' }} />
              </div>
          ...
          >
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
              <div>
                ...
                <div className="hint">Cosine similarity</div>
              </div>
              <span className="tag">≥ 0.92</span>
            </div>
            <hr className="sep" />
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
              <div>
                <div className="label">Quality rejection threshold</div>
                <div className="hint">Minimum score kept</div>
              </div>
              <span className="tag">0.80</span>
            </div>
            <hr className="sep" />
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
              <div>
              ...
              <span className="tag">12 words</span>
            </div>
            <hr className="sep" />
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
              <div>
        ...
        <div className="card-head">
          ...
          <div className="tabs">
            <button className="tab active">
              To handle <span className="muted">12</span>
            </button>
        ...
        <div className="card-body">
            ...
            <div className="dup" key={d.id}>
              ...
              <div className="dup-pair">
                ...
                <div className="dup-side">
                  ...
                  <span className="badge badge-outline" style={{ marginTop: 10 }}>
                    {d.remove.score}
                  </span>
                </div>
              </div>
          ...
          <div style={{ display: 'flex', justifyContent: 'center', marginTop: 4 }}>
            <button className="btn btn-outline btn-sm">
              ...
              View the remaining 10 duplicates
            </button>
          </div>
        </div>
      </div>
