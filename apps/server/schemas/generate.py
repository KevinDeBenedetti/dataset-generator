...
class DatasetGenerationRequest(BaseModel):
    ...
    model_cleaning: Optional[str] = Field(None, description="Model to use for text cleaning")
    target_language: Optional[str] = Field(None, description="Target language for QA generation")
...
class DatasetGenerationResponse(BaseModel):
    ...
    total_questions: Optional[int] = Field(None, description="Total number of generated questions")
